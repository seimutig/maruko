...
/**
 * A simplified Flink Catalog implementation for TableStore that manages databases and tables
 ...
 */
public abstract class AbstractTableStoreCatalog extends AbstractCatalog {
    ...
    public AbstractTableStoreCatalog(String name, String warehousePath) {
