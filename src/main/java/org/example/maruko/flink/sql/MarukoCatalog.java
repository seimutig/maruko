 ...
 * This extends AbstractMarukoCatalog to provide additional functionality.
 */
public class MarukoCatalog extends AbstractMarukoCatalog {
    
    // Using file-based storage for partitions as well, instead of in-memory map

    public MarukoCatalog(String name, String warehousePath) {
